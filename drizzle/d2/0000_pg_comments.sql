...
-- ─── public.evaluations ───
COMMENT ON TABLE public.evaluations IS '[D2 / B2G OKK] AI-оценка звонка с разбиением по блокам и критериям. Used by tabs: Аналитика, Аудит, ОКК.';
...
-- ─── public.managers ───
COMMENT ON TABLE public.managers IS '[D2 / B2G OKK] Имя/линия/команда менеджера для фильтра и подписи. Used by tabs: Аналитика, ОКК.';
...
COMMENT ON TABLE public.phantom_history IS '[D2 / B2G OKK] Дневной аггрегат покрытия webhook''ом телефонии. Used by tabs: Аудит.';
