...
- Вкладка показывает только текущие критерии. Архивные пункты первой линии удалены из
  конфигураций; выбора критериев по дате в UI нет.
- Для первой линии: `d2_qualifier` v4.0 и
