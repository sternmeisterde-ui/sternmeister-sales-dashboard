...
Метки нет там, где вопрос неприменим или ответа нет: у CallGear/WhatsApp, у входящих
(атрибуция покрывает только исходящие) и у звонков раньше 2026-07-01 — горизонта
бэкфилла dialer-sync. Это намеренно строже дайлер-вида «Активности»: там всё
неатрибутированное считается «вручную», что в пер-звонковом списке соврало бы про
историю.
