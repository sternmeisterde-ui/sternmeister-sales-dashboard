...
- `out_unanswered` — **мы звонили**: исходящий недозвон (duration < 1) в
  9:00–19:00 Berlin, по номеру никто не перезвонил в течение 15 минут.
...
- `in_missed` — **клиент звонил сам** (добавлено 2026-07-29 по жалобе РОПа
  «в потерянных нет входящих»): входящий на линию `KOM%` в 9:00–19:00,
  никто не взял (duration < 1) и не перезвонили в течение 24 часов.
...
Порядок величин (27.07.2026): 63 недозвона + 1 пропущенный входящий.
