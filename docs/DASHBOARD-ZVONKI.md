...
| `GET /api/dashboard/b2b-tile-details` | плитки Исходящие/Принятых/%/Ожидание (b2b) и Ожидание (b2g) | платформы, менеджер×платформа, почасовка, ожидание. `&line=1\|2\|3` сужает ростер (b2g) |
