// Применение решения по жалобе. Единственный канал записи — batch
// POST /api/complaints/resolve (Claude-адъюдикатор из OKK-репо); ручного
// редактирования в UI нет намеренно (решение владельца 2026-08-05).
//
// Семантика:
