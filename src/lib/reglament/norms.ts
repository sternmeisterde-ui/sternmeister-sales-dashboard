...
/**
 * 🟡 ПРЕДВАРИТЕЛЬНЫЙ норматив SLA первого звонка (сек от начала смены).
 * Точный порог интегратора не восстановлен (сводный «SLA, %» не сходится
 * с простой долей ≤ T — справочник 23a §4); 10 минут — лучший кандидат
 * по подбору и нижний бакет вкладки Looker. Уточнить у РОПа.
 */
