...
export interface EvalCriterion {
  ...
  applicable?: boolean;
  // Вердикт унаследован из прошлого звонка клиента (OKK verdict-inheritance,
  // с 2026-07-07): id звонка-донора. Такие строки входят в балл звонка, но
  // НЕ должны попадать в покритериальные агрегаты (двойной счёт) и в списки
  // «ошибок этого звонка».
  inherited_from_call_id?: string;
}
