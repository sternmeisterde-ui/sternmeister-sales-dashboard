                  ...
                  tip={
                    <div className="flex flex-col gap-1.5 text-left">
                      <p>
                        ...
                        в статус «Новый лид» (Бух Гос) до первого исходящего звонка по нему.
                      </p>
                      <p>
                        Рабочее время — по графику смен того, кто сделал первое касание (файл РОПа,
                        лист «График на месяц»). Дни и люди вне файла считаются по Пн–Сб 09:00–18:00.
                      </p>
                      <div>
                      ...
                      <p>
                        Не считаются лиды с флагом «Исключить из аналитики» и с причинами закрытия:
                        Дубль бух, Дубль мед, Неправильный номер, Неквал АГЕНТ.
                      </p>
                      <p>
                        Считается {scopeWord}. Засчитывается не ответственному в Kommo (там у свежего
                        лида стоит РОП), а тому, кто первым позвонил.
                      </p>
