                ...
                <CallMetricTile
                  ...
                  tip={
                    <div className="flex flex-col gap-2 text-left">
                      <p>
                        <span className="text-slate-100 font-semibold">Сколько клиент ждал первого звонка</span>,
                        считая только рабочее время.
                      </p>

                      <div>
                        <p className="text-slate-100 font-semibold mb-0.5">Отсчёт идёт:</p>
                        <ul className="list-disc pl-4 space-y-0.5">
                          <li>с входа сделки в статус «Новый лид» (воронка Бух Гос);</li>
                          <li>до первого исходящего звонка по ней.</li>
                        </ul>
                      </div>

                      <div>
                        <p className="text-slate-100 font-semibold mb-0.5">Из этого времени вычитается:</p>
                        <ul className="list-disc pl-4 space-y-0.5">
                          <li>всё вне смены — по графику из файла РОПа;</li>
                          <li>обед, встречи и обучение — по отметкам менеджера;</li>
                          <li>разговоры с другими клиентами.</li>
                        </ul>
                        <p className="text-slate-500 mt-0.5">
                          Берётся занятость того, кто позвонил первым. «Перерыв» и «Занят» не
                          вычитаются — в «Активности» они тоже считаются простоем.
                        </p>
                      </div>

                      <div>
                        <p className="text-slate-100 font-semibold mb-0.5">Когда SLA не считается:</p>
                        <ul className="list-disc pl-4 space-y-0.5">
                          <li>сделка не проходила статус «Новый лид»;</li>
                          <li>звонка не было, а сделка уже закрыта;</li>
                          <li>причина закрытия: Дубль бух, Дубль мед, Неправильный номер, Неквал АГЕНТ;</li>
                          <li>стоит флаг «Исключить из аналитики».</li>
                        </ul>
                      </div>

                      <div>
                        <p className="text-slate-100 font-semibold mb-0.5">Особые случаи:</p>
                        <ul className="list-disc pl-4 space-y-0.5">
                          <li>позвонили раньше или в момент появления сделки — 0 минут;</li>
                          <li>звонка ещё нет, сделка открыта — время идёт до сих пор.</li>
                        </ul>
                      </div>

                      <p className="text-slate-500">
                        Засчитывается тому, кто позвонил первым, — не ответственному в Kommo:
                        у свежих сделок там стоит РОП. Считается {scopeWord}.
                      </p>
                      <p className="text-slate-500">
                        Дни без графика и людей вне файла считаем по Пн–Сб 09:00–18:00. Отметки
                        статусов собираются с 27.07.2026 — за более ранние периоды вычета нет.
                      </p>
